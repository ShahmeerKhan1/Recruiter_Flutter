...
class CTP20_1 extends StatefulWidget {

  String data;

  CTP20_1({Key? key, required this.data}) : super(key: key);

  @override
  _CTP20_1State createState() => _CTP20_1State();
}

class _CTP20_1State extends State<CTP20_1> {
