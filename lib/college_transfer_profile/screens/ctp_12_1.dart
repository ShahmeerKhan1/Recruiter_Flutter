...
class CTP_12_1 extends StatefulWidget {
  final VideoPlayerController? videoPlayerController;
  final HighLightTabModel data;

  const CTP_12_1({Key? key, required this.videoPlayerController, required this.data})
      : super(key: key);

  @override
  State<CTP_12_1> createState() => _CTP_12_1State();
}

class _CTP_12_1State extends State<CTP_12_1> {
  bool _isFollow = true;
