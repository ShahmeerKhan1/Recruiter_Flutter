...
import 'sap_app_bar.dart';

class SAP_Highlights_Tab extends StatefulWidget {
  const SAP_Highlights_Tab({Key? key}) : super(key: key);

  @override
  _SAP_Highlights_TabState createState() => _SAP_Highlights_TabState();
}

class _SAP_Highlights_TabState extends State<SAP_Highlights_Tab> {
...
class _HighlightDetailState extends State<HighlightDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: sapAppBar('Video', Icons.notifications, context),
