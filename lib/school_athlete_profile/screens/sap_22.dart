...
class SAP_22 extends StatefulWidget {
  ...
  @override
  _SAP_22State createState() => _SAP_22State();
}

class _SAP_22State extends State<SAP_22> with SingleTickerProviderStateMixin {
                                      ...
                                      !editProfile
                                          ? Row(
                                              children: [
                                                InkWell(
                                                  onTap: () {
                                                    Navigator.push(context, MaterialPageRoute(builder: (_) => const SAP_26()));
                                                  },
                                                  child: Row(
                                                    children: const [
                                                      Text('800',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              print('tapped');
                              Navigator.push(context, MaterialPageRoute(builder: (_) => const SAP_31()));
                            },
                            child: Container(
                              height: 74,
                              width: 84,
