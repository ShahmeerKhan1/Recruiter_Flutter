...
class SAP_20 extends StatefulWidget {

  String data;

  SAP_20({Key? key, required this.data}) : super(key: key);

  @override
  _SAP_20State createState() => _SAP_20State();
}

class _SAP_20State extends State<SAP_20> {
