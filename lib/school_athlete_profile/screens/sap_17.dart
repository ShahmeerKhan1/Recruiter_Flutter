...
class SAP_17 extends StatefulWidget {
  const SAP_17({Key? key}) : super(key: key);

  @override
  _SAP_17State createState() => _SAP_17State();
}

class _SAP_17State extends State<SAP_17> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: sapAppBar('New Message', Icons.notifications, context),
                    ...
                    return InkWell(
                      onTap: () {
                        ...
                        Future.delayed(const Duration(seconds: 2), () {
                          Navigator.push(context, MaterialPageRoute(builder: (_) => SAP_19(data: _list[index].name)));
                        });
                      },
                      child: Container(
