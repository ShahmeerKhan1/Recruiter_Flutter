...
class SAP_19 extends StatefulWidget {

  String data;

  SAP_19({Key? key, required this.data}) : super(key: key);

  @override
  _SAP_19State createState() => _SAP_19State();
}

class _SAP_19State extends State<SAP_19> {
