...
import 'package:recruiter_flutter/school_athlete_profile/screens/sap_28.dart';
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => SAP_35()));
                    },
                    child: Container(
                      width: 85,
                      height: 40,
