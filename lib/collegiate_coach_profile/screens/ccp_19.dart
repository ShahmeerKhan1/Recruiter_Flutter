...
class CCP_19 extends StatefulWidget {

  String data;

  CCP_19({Key? key, required this.data}) : super(key: key);

  @override
  _CCP_19State createState() => _CCP_19State();
}

class _CCP_19State extends State<CCP_19> {
