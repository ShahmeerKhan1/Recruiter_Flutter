...
class CCP6_2 extends StatefulWidget {
  const CCP6_2({Key? key}) : super(key: key);

  @override
  _CCP6_2State createState() => _CCP6_2State();
}

class _CCP6_2State extends State<CCP6_2> {
              ...
              Container(
                ...
                child:  Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_) => CCP6_3()));
                    },
