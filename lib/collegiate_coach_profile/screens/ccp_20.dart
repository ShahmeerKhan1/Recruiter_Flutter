...
class CCP_20 extends StatefulWidget {

  String data;

  CCP_20({Key? key, required this.data}) : super(key: key);

  @override
  _CCP_20State createState() => _CCP_20State();
}

class _CCP_20State extends State<CCP_20> {
