...
class CCP_12 extends StatefulWidget {
  final VideoPlayerController? videoPlayerController;
  final HighLightTabModel data;

  const CCP_12({Key? key, required this.videoPlayerController, required this.data})
      : super(key: key);

  @override
  State<CCP_12> createState() => _CCP_12State();
}

class _CCP_12State extends State<CCP_12> {
  bool _isFollow = true;
