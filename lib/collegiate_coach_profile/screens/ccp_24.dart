...
import 'package:recruiter_flutter/collegiate_coach_profile/screens/ccp_26.dart';
import 'package:recruiter_flutter/model/followers_model.dart';
import 'package:recruiter_flutter/util/colors.dart';
import 'package:recruiter_flutter/widgets/textfield_focused_border.dart';
import 'package:recruiter_flutter/widgets/textfield_input_border.dart';

class CCP_24 extends StatefulWidget {
  const CCP_24({Key? key}) : super(key: key);

  @override
  _CCP_24State createState() => _CCP_24State();
}

class _CCP_24State extends State<CCP_24> with SingleTickerProviderStateMixin {
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, index) {
                  return InkWell(
                    onTap: () {
                      print('navigate');
                      Navigator.push(context, MaterialPageRoute(builder: (_) => const CCP_26()));
                    },
                    child: Container(
