...
import 'package:recruiter_flutter/school_coach_profile/screens/scp_9_1.dart';
import 'package:recruiter_flutter/util/colors.dart';

class SCPPostTab extends StatefulWidget {
  const SCPPostTab({Key? key}) : super(key: key);

  @override
  _SCPPostTabState createState() => _SCPPostTabState();
}

class _SCPPostTabState extends State<SCPPostTab> {
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: GetBuilder<PostControllerSCP>(
          builder: (_const) {
                  ...
                  itemBuilder: (BuildContext context, index) {
                    return InkWell(
                      onTap: () async {
                        ...
                        push(
                          MaterialPageRoute(
                            builder: (context) => SCP9_1(data: _const.postLists[index]),
                          ),
                        );
                        setState(() {
...
//                       push(
//                         MaterialPageRoute(
//                           builder: (context) => CTP9_1(data: _const.postLists[index]),
//                         ),
//                       );
//                       setState(() {
//
...
//                             const SizedBox(height: 6),
//                             //  _con.postListsCtp[index].img == null ?
//                             _const.postListsCtp[index].img != null ? Expanded(
//                               flex: 5,
//                               child: Column(
//                                 crossAxisAlignment: CrossAxisAlignment.stretch,
//                                 children: [
//                                   Expanded(child: _const.postListsCtp[index].img != null ?
//                                   Padding(
//                                     padding: const EdgeInsets.only(bottom: 8.0),
//                                     child: Image.file(_const.postListsCtp[index].img!, fit: BoxFit.fill),
//                                   ) : Container()),
//                                   // Row(
//                                   //   children: [
//                                   //     Expanded(
...
//                                         onTap: () {
//                                           setState(() {
//                                             _const.postListsCtp[index].heartReact = !_const.postListsCtp[index].heartReact;
//                                           });
//                                           print('heart toggle');
//                                         },
//                                         child: !_const.postListsCtp[index].heartReact ? Icon(Icons.favorite_outline,
//                                             color: AppColor.greyBorderColor, size: 20)
//                                             : Icon(Icons.favorite,
//                                             color: Colors.red, size: 20),
//                                       ),
...
//                                         onTap: () {
//                                           setState(() {
//                                             _const.postListsCtp[index].starReact = !_const.postListsCtp[index].starReact;
//                                           });
//                                         },
//                                         child: !_const.postListsCtp[index].starReact ? Icon(Icons.star_border,
//                                             color: AppColor.greyBorderColor, size: 20)
//                                             : Icon(Icons.star,
//                                             color: AppColor.goldenColor, size: 20),
//                                       ),
