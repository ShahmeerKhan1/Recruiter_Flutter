...
class SCPEventDetail extends StatefulWidget {
  ...
  const SCPEventDetail({Key? key, required this.data}) : super(key: key);

  @override
  _SCPEventDetailState createState() => _SCPEventDetailState();
}

class _SCPEventDetailState extends State<SCPEventDetail> {
