...
class SCP8_1 extends StatefulWidget {
  const SCP8_1({Key? key}) : super(key: key);

  @override
  _SCP8_1State createState() => _SCP8_1State();
}

class _SCP8_1State extends State<SCP8_1> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GetBuilder<HighlightControllerSCP>(
          builder: (_cont) {
