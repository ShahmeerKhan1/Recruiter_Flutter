...
class SCP7_4 extends StatefulWidget {
  const SCP7_4({Key? key}) : super(key: key);

  @override
  _SCP7_4State createState() => _SCP7_4State();
}

class _SCP7_4State extends State<SCP7_4> {
                        ...
                        child: InkWell(
                          onTap: () {
                            if ((title.text != "") &&
                                (description.text != "") &&
                                (_VideoController != null)) {
                              Get.put(HighlightControllerSCP()).highlightList.add(
                                  HighLightTabModel(
