...
class SCP7_2 extends StatefulWidget {
  ...
  @override
  _SCP7_2State createState() => _SCP7_2State();
}

class _SCP7_2State extends State<SCP7_2> {
                          ...
                          child: GestureDetector(
                            onTap: () {
                              if ((comment.text == "") && (imageFile == null)) {
                                ...
                                Get.put(PostControllerSCP()).postLists.add(
                                PostTabModel(
                                    profileImg: 'assets/drawer_img.png',
                                    userName: 'Martin Mangram ',
                                    time: '1m',
                            ...
                            //    Navigator.pushNamed(context, 'home');
                                // Navigator
                                //     .of(context)
                                //     .pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => SCP7()));
                              //  Get.to(()=> SCP7());
                              //  Get.offAll(const SCP7());
