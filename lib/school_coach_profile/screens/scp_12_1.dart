...
import '../../model/highlight_tab_model.dart';

class SCP_12_1 extends StatefulWidget {
  final VideoPlayerController? videoPlayerController;
  final HighLightTabModel data;

  const SCP_12_1({Key? key, required this.videoPlayerController, required this.data})
      : super(key: key);

  @override
  State<SCP_12_1> createState() => _SCP_12_1State();
}

class _SCP_12_1State extends State<SCP_12_1> {
  bool _isFollow = true;
