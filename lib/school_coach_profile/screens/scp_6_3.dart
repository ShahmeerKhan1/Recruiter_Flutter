  ...
  choosePath(){
    switch(selectedIndex){
      ...
      case 0:
        ...
        break;
      case 1:
        Navigator.push(context, MaterialPageRoute(builder: (_) => const SCP7()));        print('index 1');
        break;
      case 2:
        Navigator.push(context, MaterialPageRoute(builder: (_) => const SCP7()));        print('index 2');
        break;
      case 3:
        Navigator.push(context, MaterialPageRoute(builder: (_) => const SCP7()));        print('index 3');
        break;
      case 4:
        Navigator.push(context, MaterialPageRoute(builder: (_) => const SCP7()));        print('index 4');
        break;
      case 5:
        Navigator.push(context, MaterialPageRoute(builder: (_) => const SCP7()));        print('index 5');
        break;
    }
  }
}
