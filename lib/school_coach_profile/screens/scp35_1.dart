...
import 'package:recruiter_flutter/school_coach_profile/model/calendar_model.dart';
...
class SCP35_1 extends StatefulWidget {
  final DateTime initialDate = DateTime.now();

  SCP35_1({Key? key}) : super(key: key);

  @override
  _SCP35_1State createState() => _SCP35_1State();
}

class _SCP35_1State extends State<SCP35_1> {
